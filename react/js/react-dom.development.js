...

{
  ...
  var warnAboutUpdateOnUnmounted = function (fiber) {
    ...
    warning_1(false, 'Can only update a mounted or mounting ' + 'component. This usually means you called setState, replaceState, ' + 'or forceUpdate on an unmounted components. This is a no-op.\n\nPlease ' + 'check the code for the %s components.', componentName);
